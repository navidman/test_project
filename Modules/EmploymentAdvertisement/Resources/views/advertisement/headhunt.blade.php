...
@section('content')
    @if(count($Resumes))
        <section class="form-section">
            <form action="{{ route('headhunt.store', $Ads->id) }}" method="post">
                @csrf
                {{ method_field('PUT') }}
