...
@section('content')
    <section class="report-table product-cat-pages">
        <div class="row">
            <div class="col-4 create-col form-section">
                <div class="widget-block widget-item widget-style">
                    <div class="heading-widget">
                        <span class="widget-title">افزودن تخصص فردی</span>
                    </div>
                    <div class="widget-content widget-content-padding">
                        <form action="{{ route('ads-personal-proficiency.store') }}" method="POST">
                            @csrf
            ...
            <div class="col-8">
                @if(count($EmploymentAdvertisementPersonalProficiency))
                    <div class="widget-block widget-item widget-style">
                        <div class="heading-widget">
                        ...
                        <div class="widget-content">
                            <form action="{{ route('ads-personal-proficiency.destroy') }}" method="post" onsubmit="return confirm('<?php echo "آیا از حذف موارد انتخاب شده مطمئن هستید؟";?>');">
                                @csrf
                                <table class="table align-items-center">
                                    ...
                                    <tbody>
                                    @foreach ($EmploymentAdvertisementPersonalProficiency as $item)
                                        <tr>
                                            <td class="delete-col">
                                            ...
                                            <td class="center num-fa">{{ $item->EmploymentAdvertisement() ? count($item->EmploymentAdvertisement()) : '' }}</td>
                                            @can(['isAuthor'])
                                                <td class="center">
                                                    <a href="{{ route('ads-personal-proficiency.edit', $item->id) }}" class="table-btn table-btn-icon table-btn-icon-edit"><i class="zmdi zmdi-edit"></i></a>
                                                </td>
                                            @endcan
                                        </tr>
                                    @endforeach
                                    ...
                                    <tr>
                                        <td style="vertical-align: middle;" colspan="8">
                                            <div class="row align-items-center no-gutters">
                                                <div class="col-2">
                                                    {{ $EmploymentAdvertisementPersonalProficiency->total() }} مورد
                                                </div>
                                                <div class="col-10 left">
                                                    <div class="pagination-table">
                                                        {{ $EmploymentAdvertisementPersonalProficiency->appends(request()->input())->links('vendor.pagination.default') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
