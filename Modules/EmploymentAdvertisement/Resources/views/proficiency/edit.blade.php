...
@section('content')
    <section class="form-section">
        <form action="{{ route('advertisement-proficiency.update', $EmploymentAdvertisementProficiency->id) }}" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-9">
                    <div class="widget-block widget-item widget-style">
                        ...
                        <div class="widget-content widget-content-padding">
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                @endif
                                {!! Form::text('title',$EmploymentAdvertisementProficiency->title,[ 'id'=>'title' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'عنوان تخصص را وارد نمایید', 'dir' => 'auto']) !!}
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                @endif
                                {!! Form::text('slug',$EmploymentAdvertisementProficiency->slug,[ 'id'=>'slug' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'شناسه تخصص را وارد نمایید', 'dir' => 'auto']) !!}
