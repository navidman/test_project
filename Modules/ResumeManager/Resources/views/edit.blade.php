...
@section('content')
    ...
    <section class="form-section">
        <form action="{{ route('resume-manager.update', $Resume->id) }}" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-9">
                            ...
                            <div @class('row')>
                                <div class="col-12 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::text('full_name',$Resume->user_tbl->full_name,[ 'id'=>'full_name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'نام و نام خانوادگی را وارد نمایید']) !!}
                                        {!! Form::label('full_name','نام و نام خانوادگی:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::email('email',$Resume->user_tbl->email,[ 'id'=>'email' , 'class'=>'col-12 field-style input-text left', 'placeholder'=>'ایمیل کاربر را وارد نمایید']) !!}
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::text('phone',$Resume->user_tbl->phone,[ 'id'=>'phone' , 'class'=>'col-12 field-style input-text left', 'placeholder'=>'تلفن را وارد نمایید']) !!}
                                        {!! Form::label('phone','تلفن:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('province'))
                                            <span class="col-12 message-show">{{ $errors->first('province') }}</span>
                                        @endif
                                        {!! Form::label('province','استان اجرای پروژه:',) !!}
                                        <select data-placeholder="لطفا استان را انتخاب نمایید" id="province" class="select chosen-rtl" name="province" onChange="CityList(this.value);">
                                            <option></option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '1') value="1">تهران</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '2') value="2">گیلان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '3') value="3">آذربایجان شرقی</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '4') value="4">خوزستان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '5') value="5">فارس</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '6') value="6">اصفهان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '7') value="7">خراسان رضوی</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '8') value="8">قزوین</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '9') value="9">سمنان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '10') value="10">قم</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '11') value="11">مرکزی</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '12') value="12">زنجان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '13') value="13">مازندران</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '14') value="14">گلستان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '15') value="15">اردبیل</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '16') value="16">آذربایجان غربی</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '17') value="17">همدان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '18') value="18">کردستان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '19') value="19">کرمانشاه</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '20') value="20">لرستان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '21') value="21">بوشهر</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '22') value="22">کرمان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '23') value="23">هرمزگان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '24') value="24">چهارمحال و بختیاری</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '25') value="25">یزد</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '26') value="26">سیستان و بلوچستان</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '27') value="27">ایلام</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '28') value="28">کهگلویه و بویراحمد</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '29') value="29">خراسان شمالی</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '30') value="30">خراسان جنوبی</option>
                                            <option @selected(old(
                                            "project_state", $Resume->user_tbl->province) == '31') value="31">البرز</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('city'))
                                            <span class="col-12 message-show">{{ $errors->first('city') }}</span>
                                        @endif
                                        {!! Form::label('city','شهر اجرای پروژه:',) !!}
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('level'))
                                            <span class="message-show">{{ $errors->first('level') }}</span>
                                        @endif
                                        <div class="col-12 field-style">
                                            <select data-placeholder="یک مورد را انتخاب کنید" id="level" class="select chosen-rtl" name="level">
                                                <option></option>
                                                <option value="مدیر عامل" @selected(old(
                                                "level", $Resume->level) == "مدیر عامل")>مدیر عامل</option>
                                                <option value="قائم مقام" @selected(old(
                                                "level", $Resume->level) == "قائم مقام")>قائم مقام</option>
                                                <option value="معاونت" @selected(old(
                                                "level", $Resume->level) == "معاونت")>معاونت</option>
                                                <option value="مدیر" @selected(old(
                                                "level", $Resume->level) == "مدیر")>مدیر</option>
                                                <option value="رئیس / سرپرست" @selected(old(
                                                "level", $Resume->level) == "رئیس / سرپرست")>رئیس / سرپرست</option>
                                                <option value="کارشناس ارشد / کارشناس مسئول" @selected(old(
                                                "level", $Resume->level) == "کارشناس ارشد / کارشناس مسئول")>کارشناس ارشد / کارشناس مسئول</option>کارشناس ارشد / کارشناس مسئول
                                                <option value="کارشناس" @selected(old(
                                                "level", $Resume->level) == "کارشناس")>کارشناس</option>
                                                <option value="کارمند" @selected(old(
                                                "level", $Resume->level) == "کارمند")>کارمند</option>
                                            </select>
                                        </div>
                                        {!! Form::label('level','سطح ارشديت:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('cooperation_type'))
                                            <span class="message-show">{{ $errors->first('cooperation_type') }}</span>
                                        @endif
                                        <div class="col-12 field-style">
                                            <select data-placeholder="یک مورد را انتخاب کنید" id="cooperation_type" class="select chosen-rtl" name="cooperation_type">
                                                ...
                                                "cooperation_type", $Resume->cooperation_type) == "تمام وقت")>تمام وقت</option>
                                                <option value="مشاوره" @selected(old(
                                                "cooperation_type", $Resume->cooperation_type) == "مشاوره")>مشاوره</option>
                                                <option value="پاره وقت" @selected(old(
                                                "cooperation_type", $Resume->cooperation_type) == "پاره وقت")>پاره وقت</option>
                                                <option value="پروژه ای" @selected(old(
                                                "cooperation_type", $Resume->cooperation_type) == "پروژه ای")>پروژه ای</option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('presence_type'))
                                            <span class="message-show">{{ $errors->first('presence_type') }}</span>
                                        @endif
                                        <div class="col-12 field-style">
                                            <select data-placeholder="یک مورد را انتخاب کنید" id="presence_type" class="select chosen-rtl" name="presence_type">
                                                <option></option>
                                                <option value="دورکاری" @selected(old(
                                                "presence_type", $Resume->presence_type) == "دورکاری")>دورکاری</option>
                                                <option value="هیبرید (ترکیب حضوری و دورکاری)" @selected(old(
                                                "presence_type", $Resume->presence_type) == "هیبرید (ترکیب حضوری و دورکاری)")>هیبرید (ترکیب حضوری و دورکاری)</option>
                                                <option value="حضور کامل" @selected(old(
                                                "presence_type", $Resume->presence_type) == "حضور کامل")>حضور کامل</option>
                                            </select>
                                        </div>
                                        {!! Form::label('presence_type','نوع حضور:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row no-gutters">
                                        ...
                                        <div class="col-12 field-style">
                                            <select data-placeholder="یک مورد را انتخاب کنید" id="salary" class="select chosen-rtl" name="salary">
                                                <option></option>
                                                <option value="adaptive" @selected(old(
                                                "salary", $Resume->salary) == "adaptive")>توافقی</option>
                                                <option value="basic_salary" @selected(old(
                                                "salary", $Resume->salary) == "basic_salary")>حقوق پایه (وزارت کار)</option>
                                                <option value="4-6" @selected(old(
                                                "salary", $Resume->salary) == "4-6")>از ۴ تا ۶ میلیون تومان</option>
                                                <option value="6-8" @selected(old(
                                                "salary", $Resume->salary) == "6-8")>از ۶ تا ۸ میلیون تومان</option>
                                                <option value="8-10" @selected(old(
                                                "salary", $Resume->salary) == "8-10")>از ۸ تا ۱۰ میلیون تومان</option>
                                                <option value="10-12" @selected(old(
                                                "salary", $Resume->salary) == "10-12")>از ۱۰ تا ۱۲ میلیون تومان</option>
                                                <option value="12-14" @selected(old(
                                                "salary", $Resume->salary) == "12-14")>از ۱۲ تا ۱۴ میلیون تومان</option>
                                                <option value="14-16" @selected(old(
                                                "salary", $Resume->salary) == "14-16")>از ۱۴ تا ۱۶ میلیون تومان</option>
                                                <option value="16-20" @selected(old(
                                                "salary", $Resume->salary) == "16-20")>از ۱۶ تا ۲۰ میلیون تومان</option>
                                                <option value="20-25" @selected(old(
                                                "salary", $Resume->salary) == "20-25")>از ۲۰ تا ۲۵ میلیون تومان</option>
                                                <option value="25-30" @selected(old(
                                                "salary", $Resume->salary) == "25-30")>از ۲۵ تا ۳۰ میلیون تومان</option>
                                                <option value="30-35" @selected(old(
                                                "salary", $Resume->salary) == "30-35")>از ۳۰ تا ۳۵ میلیون تومان</option>
                                                <option value="35-40" @selected(old(
                                                "salary", $Resume->salary) == "35-40")>از ۳۵ تا ۴۰ میلیون تومان</option>
                                                <option value="40-45" @selected(old(
                                                "salary", $Resume->salary) == "40-45")>از ۴۰ تا ۴۵ میلیون تومان</option>
                                                <option value="45-50" @selected(old(
                                                "salary", $Resume->salary) == "45-50")>از ۴۵ تا ۵۰ میلیون تومان</option>
                                                <option value="more_than_50" @selected(old(
                                                "salary", $Resume->salary) == "more_than_50")>بیش از ۵۰ میلیون تومان</option>
                                            </select>
                                        </div>
                                        {!! Form::label('salary','مقدار حقوق درخواستی:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('sarbazi'))
                                            <span class="message-show">{{ $errors->first('sarbazi') }}</span>
                                        @endif
                                        <div class="col-12 field-style">
                                            <select data-placeholder="یک مورد را انتخاب کنید" id="sarbazi" class="select chosen-rtl" name="sarbazi">
                                                <option></option>
                                                <option value="غیر مشمول" @selected(old(
                                                "sarbazi", $Resume->sarbazi) == "غیر مشمول")>غیر مشمول</option>
                                                <option value="مشمول" @selected(old(
                                                "sarbazi", $Resume->sarbazi) == "مشمول")>مشمول</option>
                                                <option value="سرباز" @selected(old(
                                                "sarbazi", $Resume->sarbazi) == "سرباز")>سرباز</option>
                                                <option value="معافیت" @selected(old(
                                                "sarbazi", $Resume->sarbazi) == "معافیت")>معافیت</option>
                                                <option value="پایان خدمت" @selected(old(
                                                "sarbazi", $Resume->sarbazi) == "پایان خدمت")>پایان خدمت</option>
                                            </select>
                                        </div>
                                        {!! Form::label('sarbazi','وضعیت سربازی:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('birth_day'))
                                            <span class="col-12 message-show">{{ $errors->first('birth_day') }}</span>
                                        @endif
                                        {!! Form::text('birth_day',$Resume->birth_day,[ 'id'=>'birth_day' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'تاریخ تولد را وارد نمایید']) !!}
                                        {!! Form::label('birth_day','تاریخ تولد:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('skills'))
                                            <span class="message-show">{{ $errors->first('skills') }}</span>
                                        @endif
                                        <div class="col-12 field-style">
                                            <select data-placeholder="یک مورد را انتخاب کنید" id="skills" class="select chosen-rtl" name="skills">
                                                <option></option>
                                                @forelse($Skills as $item)
                                                    <option value="{{ $item->id }}" @selected(old("cat", $Resume->skills) ==
                                                    $item->id)>{{ $item->title }}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        {!! Form::label('skills','گروه شغلی:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('job_position'))
                                            <span class="col-12 message-show">{{ $errors->first('job_position') }}</span>
                                        @endif
                                        {!! Form::text('job_position',$Resume->job_position,[ 'id'=>'job_position' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'عنوان شغلی کارجو را وارد نمایید']) !!}
                                        {!! Form::label('job_position','عنوان شغلی کارجو:',['class'=>'col-12']) !!}
                                    </div>
                                </div>
                    ...
                    @forelse($Resume->resume_introducer as $item)
                        <div class="widget-block widget-item widget-style">
                            <div class="heading-widget">
                                <span class="widget-title">{{ $item->employment_tbl->company_name_fa ? $item->employment_tbl->company_name_fa :  $item->employment_tbl->full_name  }}</span>
                            </div>
                            <div class="widget-content widget-content-padding">
                                <div class='border-bottom pb-2 mb-4'>
                                    <strong>نحوه آشنایی</strong>
                                    <div>{{$item->recognition ? 'مصاحبه' : 'همکاری'}}</div>
                                </div>
                                <div class='border-bottom pb-2 mb-4'>
                                ...
                                <div class='border-bottom pb-2 mb-4'>
                                    ...
                                    <div>{{$item->organizational_behavior}}</div>
                                </div>
                                <div class='border-bottom pb-2 mb-4'>
                                    <strong>اشتیاق در شغل</strong>
                                    <div>{{$item->passion}}</div>
                                </div>
                                <div class='border-bottom pb-2 mb-4'>
                                    <strong>حقوق و دستمزد</strong>
                                    <div>{{$item->salary_rate}}</div>
                                </div>
                                <div class='border-bottom pb-2 mb-4'>
                                    <strong>با این اوصاف چرا امکان همکاری فراهم نگردید؟</strong>
                                    <div>{{$item->reason_adjustment}}</div>
                                </div>
                                <div class='border-bottom pb-2 mb-4'>
                                    <strong>نظر کارفرما</strong>
                                    <div>{{$item->comment_employment}}</div>
                                </div>
                                <div class='border-bottom pb-2 mb-4'>
                                    <strong>نظر تخصصی کارفرما</strong>
                                    <div>{{$item->expert_opinion}}</div>
                                </div>
                            </div>
                        </div>
                    @empty
                                    ...
                                    <div class="form-group">
                                        <div class="requirements-repeater text-field-repeater">
                                            <div class="field-list" id="repeat_list_problem">
                                                @php $ProblemKey = 1 @endphp
                                                @if($Resume->requirements)
                                                    @if(isset(json_decode($Resume->requirements, true)['problem']))
                                                        @forelse(json_decode($Resume->requirements, true)['problem'] as $item)
                                                            <div id="field-repeat-item-problem-{{ $ProblemKey }}">
                                                                <div class="text-field">
                                                                    <div class='text-field'>
                                                                        <input placeholder='مشکل را وارد نمایید...' class='field-style input-text' type="text" name="requirements[problem][{{ $ProblemKey }}]" value="{{ $item }}">
                                                                        <span class='delete-row icon-close' onclick='delete_item_problem({{ $ProblemKey }})'>
                                    ...
                                    <div class="form-group">
                                        <div class="requirements-repeater text-field-repeater">
                                            <div class="field-list" id="repeat_list_suggest">
                                                @php $SuggestKey = 1 @endphp
                                                @if($Resume->requirements)
                                                    @if(isset(json_decode($Resume->requirements, true)['suggest']))
                                                        @forelse(json_decode($Resume->requirements, true)['suggest'] as $item)
                                                            <div id="field-repeat-item-suggest-{{ $SuggestKey }}">
                                                                <div class="text-field">
                                                                    <div class='text-field'>
                                                                        <input placeholder='پیشنهاد را وارد نمایید...' class='field-style input-text' type="text" name="requirements[suggest][{{ $SuggestKey }}]" value="{{ $item }}">
                                                                        <span class='delete-row icon-close' onclick='delete_item_suggest({{ $SuggestKey }})'>
                                                                        <span class='zmdi zmdi-close'></span>
                                                                    </span>
                                                                    </div>
                                                                </div>
                ...
                <div class="col-3">
                    ...
                    <div class="widget-block widget-item widget-style">
                        ...
                        <div class="widget-content widget-content-padding widget-content-padding-side">
                            ...
                            <div class="form-group row no-gutters">
                                <div class="col-12 field-style">
                                    <select data-placeholder="یک مورد را انتخاب کنید" class="select chosen-rtl" name="status" id="status">
                                        <option value="pending_operator" @selected(old(
                                        "status", $Resume->status) == "pending_operator")> در انتظار تایید تاپلیکنت</option>
                                        <option value="toplicant_reject" @selected(old(
                                        "status", $Resume->status) == "toplicant_reject")>✘ رد توسط تاپلیکنت</option>
                                        <option value="pending_job_seeker" @selected(old(
                                        "status", $Resume->status) == "pending_job_seeker")>✓ تایید تاپلیکنت</option>
                                        <option value="job_seeker_reject" @selected(old(
                                        "status", $Resume->status) == "job_seeker_reject")>رد توسط کارجو</option>
                                        <option value="accept_job_seeker" @selected(old(
                                        "status", $Resume->status) == "accept_job_seeker")>تایید توسط کارجو</option>
                                        <option value="expire" @selected(old(
                                        "status", $Resume->status) == "expire")>منقضی شده</option>
                                    </select>
                                </div>

                                {!! Form::label('status','وضعیت رزومه',['class'=>'col-12']) !!}
                            </div>

                            <div class="form-group row no-gutters">
                                @if($errors->has('access_resume'))
                                    <span class="message-show">{{ $errors->first('access_resume') }}</span>
                                @endif
                                <div class="col-12 field-style">
                                    <select data-placeholder="یک مورد را انتخاب کنید" id="access_resume" class="select chosen-rtl" name="access_resume">
                                        ...
                                        "access_resume", $Resume->access_resume) == "all")> قابل نمایش برای همه</option>
                                        <option value="cooperation_companies" @selected(old(
                                        "access_resume", $Resume->access_resume) == "cooperation_companies")>فقط شرکت های همکار</option>
                                    </select>
                                </div>
                                {!! Form::label('access_resume','چه کسانی دسترسی داشته باشند:',['class'=>'col-12']) !!}
                            </div>

                            {{-- جنسیت --}}
                            <div class="form-group row no-gutters">
                                @if($errors->has('gender'))
                                    <span class="message-show">{{ $errors->first('gender') }}</span>
                                @endif
                                <div class="col-12 field-style">
                                    <select data-placeholder="یک مورد را انتخاب کنید" id="gender" class="select chosen-rtl" name="gender">
                                        ...
                                        "gender", $Resume->user_tbl->gender) == "male")> آقا</option>
                                        <option value="female" @selected(old(
                                        "gender", $Resume->user_tbl->gender) == "female")>خانم</option>
                                    </select>
                                </div>
                            ...
                            {{-- نحوه آشنایی --}}
                            {{--                            <div class="form-group row no-gutters">--}}
                            {{--                                @if($errors->has('recognition'))--}}
                            {{--                                    <span class="message-show">{{ $errors->first('recognition') }}</span>--}}
                            {{--                                @endif--}}
                            {{--                                <div class="col-12 field-style">--}}
                            {{--                                    <select data-placeholder="یک مورد را انتخاب کنید" id="recognition" class="select chosen-rtl" name="recognition">--}}
                            {{--                                        <option></option>--}}
                            {{--                                        <option value="true" @selected(old(--}}
                            {{--                                        "recognition", $Resume->recognition) == "true")>مصاحبه</option>--}}
                            {{--                                        <option value="false" @selected(old(--}}
                            {{--                                        "recognition", $Resume->recognition) == "false")>همکاری</option>--}}
                            {{--                                    </select>--}}
                            {{--                                </div>--}}
                            {{--                                {!! Form::label('recognition','نحوه آشنایی:',['class'=>'col-12']) !!}--}}
                            {{--                            </div>--}}
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    <div class="col-12 field-style custom-select-field">
                                        <div class="thumbnail-image-upload">
                                            <div>
                                                <label for="thumbnail-image" id="thumbnail-label" class="thumbnail-label"><img id="thumbnail-preview" src="@if($Resume->user_tbl->avatar){{ asset( 'storage/' . \Modules\FileLibrary\Entities\FileLibrary::find($Resume->user_tbl->avatar)->path .'full/'. \Modules\FileLibrary\Entities\FileLibrary::find($Resume->user_tbl->avatar)->file_name)  }}@else{{ asset('public/modules/dashboard/admin/img/base/icons/image.svg') }}@endif"></label>
                    ...
                    <div class="widget-content widget-content-padding widget-content-padding-side">
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding widget-content-padding-side">
                                @if($Resume->resume_file_tbl)
                                    <div class="download-item light-mode fs-3 fw-bold mb-2">
                                        <a class="d-inline-block p-2 w-100 text-center border-radius-px-5 bg-info" href="{{ asset( 'storage/' . $Resume->resume_file_tbl->path . $Resume->resume_file_tbl->file_name)  }}">دانلود فایل رزومه</a>
                                    </div>
                                @endif
                                @if($Resume->interview_file)
                                    <div class="download-item light-mode fs-3 fw-bold">
                                        <a class="d-inline-block p-2 w-100 text-center border-radius-px-5 bg-info" href="{{ asset( 'storage/' . $Resume->interview_file_tbl->path . $Resume->interview_file_tbl->file_name)  }}">دانلود فایل مصاحبه</a>
                                    </div>
                                @endif
                            </div>
                        </div>
...
@section('footer')
    ...
    {{-- Check Old Data for Update --}}
    <script>
        CityList({{ $Resume->user_tbl->province }});
        const $select = document.querySelector('#city');
        $select.value = '{{ $Resume->user_tbl->city }}'
        $(".select").trigger("chosen:updated");
    </script>
