                ...
                <div class="col-9">
                            ...
                            <div @class('row')>
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::text('full_name',null,[ 'id'=>'full_name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'نام و نام خانوادگی کاربر را وارد نمایید']) !!}
                                    ...
                                    <div class="form-group row no-gutters">
                                        ...
                                        <div class="col-12 field-style">
                                            <select data-placeholder="یک مورد را انتخاب کنید" id="gender" class="select chosen-rtl" name="gender">
                                                <option></option>
                                                <option value="male" @selected(old("gender") == "male")> آقا</option>
                                                <option value="female" @selected(old("gender") == "female")>خانم</option>
                                            </select>
                                        </div>
                    ...
                    <div class="widget-block widget-item widget-style">
                        <div class="heading-widget">
                            <div class="row">
                                <div class="col-9">
                                    <span class="widget-title">تنظیمات نمایه</span>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::text('company_name_fa',null,[ 'id'=>'company_name_fa' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'نام شرکت را وارد نمایید']) !!}
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::text('company_name_en',null,[ 'id'=>'company_name_en left' , 'class'=>'col-12 field-style input-text left', 'placeholder'=>'نام شرکت را وارد نمایید']) !!}
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        <select data-placeholder="لطفا استان را انتخاب نمایید" id="province" class="select chosen-rtl" name="province" onChange="CityList(this.value);">
                                            <option></option>
                                            <option @selected(old(
                                            "project_state") == '1') value="1">تهران</option>
                                            <option @selected(old(
                                            "project_state") == '2') value="2">گیلان</option>
                                            <option @selected(old(
                                            "project_state") == '3') value="3">آذربایجان شرقی</option>
                                            <option @selected(old(
                                            "project_state") == '4') value="4">خوزستان</option>
                                            <option @selected(old(
                                            "project_state") == '5') value="5">فارس</option>
                                            <option @selected(old(
                                            "project_state") == '6') value="6">اصفهان</option>
                                            <option @selected(old(
                                            "project_state") == '7') value="7">خراسان رضوی</option>
                                            <option @selected(old(
                                            "project_state") == '8') value="8">قزوین</option>
                                            <option @selected(old(
                                            "project_state") == '9') value="9">سمنان</option>
                                            <option @selected(old(
                                            "project_state") == '10') value="10">قم</option>
                                            <option @selected(old(
                                            "project_state") == '11') value="11">مرکزی</option>
                                            <option @selected(old(
                                            "project_state") == '12') value="12">زنجان</option>
                                            <option @selected(old(
                                            "project_state") == '13') value="13">مازندران</option>
                                            <option @selected(old(
                                            "project_state") == '14') value="14">گلستان</option>
                                            <option @selected(old(
                                            "project_state") == '15') value="15">اردبیل</option>
                                            <option @selected(old(
                                            "project_state") == '16') value="16">آذربایجان غربی</option>
                                            <option @selected(old(
                                            "project_state") == '17') value="17">همدان</option>
                                            <option @selected(old(
                                            "project_state") == '18') value="18">کردستان</option>
                                            <option @selected(old(
                                            "project_state") == '19') value="19">کرمانشاه</option>
                                            <option @selected(old(
                                            "project_state") == '20') value="20">لرستان</option>
                                            <option @selected(old(
                                            "project_state") == '21') value="21">بوشهر</option>
                                            <option @selected(old(
                                            "project_state") == '22') value="22">کرمان</option>
                                            <option @selected(old(
                                            "project_state") == '23') value="23">هرمزگان</option>
                                            <option @selected(old(
                                            "project_state") == '24') value="24">چهارمحال و بختیاری</option>
                                            <option @selected(old(
                                            "project_state") == '25') value="25">یزد</option>
                                            <option @selected(old(
                                            "project_state") == '26') value="26">سیستان و بلوچستان</option>
                                            <option @selected(old(
                                            "project_state") == '27') value="27">ایلام</option>
                                            <option @selected(old(
                                            "project_state") == '28') value="28">کهگلویه و بویراحمد</option>
                                            <option @selected(old(
                                            "project_state") == '29') value="29">خراسان شمالی</option>
                                            <option @selected(old(
                                            "project_state") == '30') value="30">خراسان جنوبی</option>
                                            <option @selected(old(
                                            "project_state") == '31') value="31">البرز</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::url('website',null,[ 'id'=>'website' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'وبسایت را وارد نمایید']) !!}
                                ...
                                <div class="col-12 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::label('company_activity','حوضه های فعالیت:',['class'=>'col-12']) !!}
                                        <select multiple data-placeholder="حوضه های فعالیت شرکت را انتخاب کنید..." id="company_activity" class="select chosen-rtl num-fa" name="company_activity">
                                            <optgroup label="حوضه فناوری اطلاعات">
                                                <option @selected(old(
                                                "company_activity") == '0') value="">طراحی نرم افزار</option>
                                                <option @selected(old(
                                                "company_activity") == '1') value="">امنیت اطلاعات</option>
                                                <option @selected(old(
                                                "company_activity") == '2') value="">کامپیوتر و فناوری اطلاعات</option>
                                                <option @selected(old(
                                                "company_activity") == '3') value="">تبلیغات و بازاریابی</option>
                                                <option @selected(old(
                                                "company_activity") == '4') value="">حسابداری و مالیات</option>
                                            </optgroup>
                                            <optgroup label="پزشکی">
                                                <option @selected(old(
                                                "company_activity") == '0') value="">دندان پزشکی</option>
                                                <option @selected(old(
                                                "company_activity") == '0') value="">داروخانه</option>
                                                <option @selected(old(
                                                "company_activity") == '0') value="">پوست و مو</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group row no-gutters">
                                        ...
                                        <select data-placeholder="تعداد پرسنل را انتخاب کنید..." id="number_of_staff" class="select chosen-rtl" name="number_of_staff">
                                            <option></option>
                                            <option @selected(old(
                                            "number_of_staff") == "1-10") value="1-10">1 تا 10 نفر</option>
                                            <option @selected(old(
                                            "number_of_staff") == "11-25") value="11-25">11 تا 25 نفر</option>
                                            <option @selected(old(
                                            "number_of_staff") == "26-50") value="26-50">26 تا 50 نفر</option>
                                            <option @selected(old(
                                            "number_of_staff") == "50+") value="50+">بیش از 50 نفر</option>
                                        </select>
                                    </div>
                                </div>

                                {{-- محوریت فعالیت مد نظر --}}
                                <div class="col-6">
                                    <div class="form-group row no-gutters">
                                        @if($errors->has('job_group'))
                                            <span class="col-12 message-show">{{ $errors->first('job_group') }}</span>
                                        @endif
                                        {!! Form::label('job_group',' محوریت فعالیت مد نظر:',) !!}
                                        <select data-placeholder="محوریت فعالیت مد نظر را انتخاب کنید..." id="job_group" class="select chosen-rtl" name="job_group">
                                            <option></option>
                                            <option  @selected(old(
                                            "job_group") == "فناوری اطلاعات") value="فناوری اطلاعات">فناوری اطلاعات</option>
                                            <option  @selected(old(
                                            "job_group") == "فروشگاه") value="فروشگاه">فروشگاه</option>
                                            <option  @selected(old(
                                            "job_group") == "پزشکی") value="پزشکی">پزشکی</option>
                                            <option  @selected(old(
                                            "job_group") == "صنعتی") value="صنعتی">صنعتی</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                <div class="col-12 field-style ">
                                    <select data-placeholder="یک مورد را انتخاب کنید" id="role" class="select chosen-rtl" name="role">
                                        ...
                                        <option value="job_seeker" @selected(old("role") == "job_seeker")>کارجو</option>
                                        <option value="employer" @selected(old("role") == "employer")>کارفرما</option>
