            ...
            <div class="row">
                <div class="col-9">
                            ...
                            <div @class('row')>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::text('full_name',$Users->full_name,[ 'id'=>'full_name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'نام و نام خانوادگی کاربر را وارد نمایید']) !!}
                                ...
                                @if($Users->role == 'employer')
                                    ...
                                    <div class="col-6 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('organization_level'))
                                                <span class="col-12 message-show">{{ $errors->first('organization_level') }}</span>
                                            @endif
                                            {!! Form::text('organization_level',$Users->organization_level,[ 'id'=>'organization_level' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'نام و نام خانوادگی کاربر را وارد نمایید']) !!}
                                            {!! Form::label('organization_level','سمت سازمانی:',['class'=>'col-12']) !!}
                                        </div>
                                    </div>
                                @endif
                    ...
                    @if($Users->role == 'employer')
                        ...
                        <div class="widget-block widget-item widget-style">
                            <div class="heading-widget">
                                <span class="widget-title">اطلاعات سازمانی</span>
                            </div>
                            ...
                            <div class="widget-content widget-content-padding">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('company_name_fa'))
                                                <span class="col-12 message-show">{{ $errors->first('company_name_fa') }}</span>
                                            @endif
                                            {!! Form::text('company_name_fa',$Users->company_name_fa,[ 'id'=>'company_name_fa' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'نام شرکت را وارد نمایید']) !!}
                                            {!! Form::label('company_name_fa','نام شرکت:',['class'=>'col-12']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('company_name_en'))
                                                <span class="col-12 message-show">{{ $errors->first('company_name_en') }}</span>
                                            @endif
                                            {!! Form::text('company_name_en',$Users->company_name_en,[ 'id'=>'company_name_en' , 'class'=>'col-12 field-style input-text left', 'placeholder'=>'نام شرکت را وارد نمایید']) !!}
                                            {!! Form::label('company_name_en','نام شرکت: (انگلیسی)',['class'=>'col-12']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('economic_code'))
                                                <span class="col-12 message-show">{{ $errors->first('economic_code') }}</span>
                                            @endif
                                            {!! Form::text('economic_code',$Users->economic_code,[ 'id'=>'economic_code' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'کد اقتصادی را وارد نمایید']) !!}
                                            {!! Form::label('economic_code','کد اقتصادی:',['class'=>'col-12']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('organization_phone'))
                                                <span class="col-12 message-show">{{ $errors->first('organization_phone') }}</span>
                                            @endif
                                            {!! Form::text('organization_phone',$Users->organization_phone,[ 'id'=>'organization_phone' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'تلفن سازمانی را وارد نمایید']) !!}
                                            {!! Form::label('organization_phone','تلفن سازمانی:',['class'=>'col-12']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('number_of_staff'))
                                                <span class="col-12 message-show">{{ $errors->first('number_of_staff') }}</span>
                                            @endif
                                            {!! Form::label('number_of_staff',' تعداد پرسنل:',) !!}
                                            <select data-placeholder="تعداد پرسنل را انتخاب کنید..." id="number_of_staff" class="select chosen-rtl" name="number_of_staff">
                                                <option></option>
                                                <option @selected(old(
                                                "number_of_staff", $Users->number_of_staff) == "1-10") value="1-10">1 تا 10 نفر</option>
                                                <option @selected(old(
                                                "number_of_staff", $Users->number_of_staff) == "11-25") value="11-25">11 تا 25 نفر</option>
                                                <option @selected(old(
                                                "number_of_staff", $Users->number_of_staff) == "26-50") value="26-50">26 تا 50 نفر</option>
                                                <option @selected(old(
                                                "number_of_staff", $Users->number_of_staff) == "50+") value="50+">بیش از 50 نفر</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 mb-4">
                                        <div class="form-group row no-gutters">
                                            ...
                                            <select data-placeholder="لطفا استان را انتخاب نمایید" id="province" class="select chosen-rtl" name="province" onChange="CityList(this.value);">
                                                <option></option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '1') value="1">تهران</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '2') value="2">گیلان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '3') value="3">آذربایجان شرقی</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '4') value="4">خوزستان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '5') value="5">فارس</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '6') value="6">اصفهان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '7') value="7">خراسان رضوی</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '8') value="8">قزوین</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '9') value="9">سمنان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '10') value="10">قم</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '11') value="11">مرکزی</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '12') value="12">زنجان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '13') value="13">مازندران</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '14') value="14">گلستان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '15') value="15">اردبیل</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '16') value="16">آذربایجان غربی</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '17') value="17">همدان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '18') value="18">کردستان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '19') value="19">کرمانشاه</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '20') value="20">لرستان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '21') value="21">بوشهر</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '22') value="22">کرمان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '23') value="23">هرمزگان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '24') value="24">چهارمحال و بختیاری</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '25') value="25">یزد</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '26') value="26">سیستان و بلوچستان</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '27') value="27">ایلام</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '28') value="28">کهگلویه و بویراحمد</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '29') value="29">خراسان شمالی</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '30') value="30">خراسان جنوبی</option>
                                                <option @selected(old(
                                                "project_state", $Users->province) == '31') value="31">البرز</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('website'))
                                                <span class="col-12 message-show">{{ $errors->first('website') }}</span>
                                            @endif
                                            {!! Form::text('website',$Users->website,[ 'id'=>'website' , 'class'=>'col-12 field-style input-text left', 'placeholder'=>'وبسایت را وارد نمایید']) !!}
                                            {!! Form::label('website','وبسایت:',['class'=>'col-12']) !!}
                                        </div>
                                    </div>

                                    {{-- عنوان های شغلی مرتبط با سازمان (حداکثر ۱۵ مورد) --}}
                                    <div class="col-12 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('company_activity'))
                                                <span class="col-12 message-show">{{ $errors->first('company_activity') }}</span>
                                            @endif
                                            {!! Form::label('company_activity','عنوان های شغلی مرتبط با سازمان (حداکثر ۱۵ مورد):',['class'=>'col-12']) !!}
                                            <select multiple data-placeholder="عنوان های شغلی مرتبط با سازمان را انتخاب نمایید..." id="company_activity" class="select chosen-rtl num-fa" name="company_activity[]">
                                                @php
                                                    $CompanyActivity = json_decode($Users->company_activity);
                                                ...
                                                @forelse($Category as $item)
                                                    <option @selected(old("company_activity", in_array_all([$item->id], $CompanyActivity)) == $item->id) value="{{ $item->id }}">{{ $item->title }}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                    ...
                                    {{-- صنعت مرتبط با سازمان (حداکثر ۳ مورد) --}}
                                    <div class="col-12 mb-4">
                                        <div class="form-group row no-gutters">
                                            @if($errors->has('job_group'))
                                                <span class="col-12 message-show">{{ $errors->first('job_group') }}</span>
                                            @endif
                                            {!! Form::label('job_group','صنعت مرتبط با سازمان (حداکثر ۳ مورد)',['class'=>'col-12']) !!}
                                            <select multiple data-placeholder="صنعت مرتبط با سازمان را انتخاب نمایید..." id="job_group" class="select chosen-rtl num-fa" name="job_group[]">
                                                @php
                                                    $JobGroup = json_decode($Users->job_group);
                                                @endphp

                                                @forelse($JobGroupOptions as $item)
                                                    <option @selected(old("job_group", in_array_all([$item], $JobGroup)) == $item) value="{{ $item }}">{{ $item }}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                <div class="col-12 field-style custom-select-field">
                                    <div class="thumbnail-image-upload">
                                        <div>
                                            <label for="thumbnail-image" id="thumbnail-label" class="thumbnail-label"><img id="thumbnail-preview" src="@if($Users->avatar && $Users->avatar['path']){{ asset( 'storage/' . $Users->avatar['path'])  }}@else{{ asset('public/modules/dashboard/admin/img/base/icons/image.svg') }}@endif"></label>
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                <div class="col-12 field-style custom-select-field">
                                    <select data-placeholder="یک مورد را انتخاب کنید" id="role" class="select chosen-rtl" name="role">
                                        ...
                                        "role", $Users->role) == "admin")> مدیر ارشد</option>
                                        <option value="operator" @selected(old(
                                        "role", $Users->role) == "operator")>اپراتور</option>
                                        <option value="support" @selected(old(
                                        "role", $Users->role) == "support")>پشتیبانی</option>
                                        <option value="author" @selected(old(
                                        "role", $Users->role) == "author")>نویسنده</option>
                                        <option value="job_seeker" @selected(old(
                                        "role", $Users->role) == 'job_seeker')>کارجو</option>
                                        <option value="employer" @selected(old(
                                        "role", $Users->role) == "employer")>کارفرما</option>
                                        <option value="user" @selected(old(
                                        "role", $Users->role) == "user")>کاربر</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    <div class="col-12 field-style custom-select-field">
                                        <select data-placeholder="یک مورد را انتخاب کنید" id="status" class="select chosen-rtl" name="status">
                                            ...
                                            "status", $Users->status) == "deactivate")> غیرفعال</option>
                                            <option value="active" @selected(old(
                                            "status", $Users->status) == "active")>فعال</option>
                                        </select>
                                    </div>
...
@section('footer')
    ...
    <script>
        CityList({{ $Users->province }});
        const $select = document.querySelector('#city');
        $select.value = '{{ $Users->city }}'
        $(".select").trigger("chosen:updated");
    </script>
